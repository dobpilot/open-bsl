...
///
/// `ssa-regalloc` (16) в неё НЕ входит: он меняет семантику внутри
/// `Попытка` и включается только поимённо, пока это не исправлено. Проход,
/// попадающий в «все» до того, как он верен, превращает голый ключ в
/// ловушку.
