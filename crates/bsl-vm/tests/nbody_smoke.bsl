...
// Единственное отличие от tests/conformance/fixtures/n-body.bsl: 3 шага
// Advance вместо 50 миллионов (брифом объявленных невыполнимыми что у нас,
// что в самой 1С — масштаб растёт на ~50 знаков за итерацию) и явный
// Возврат энергии в конце, чтобы тест на стороне Rust мог её проверить.
Function Main()
	const = getConst();
