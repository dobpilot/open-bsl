...
/// и ручные `Сообщить("EXEC...." + Символ(9) + ...)` из
/// measure-unsupported.bsl, а форматные строки (`"ЧГ=0; ЧРД=."`, `"ДЛФ=Д"`)
...
fn measure_script_covers_every_registry_id() {
    ...
    //    ПОДЗАМЕР существующего вопроса (`ВОПРОС.ЧТО_ИМЕННО`) — так
    //    measure-unsupported.bsl задаёт тот же вопрос другим способом.
