...
static WRITER_METHODS: &[MethodDescriptor] = &[MethodDescriptor {
    code: MethodCode::new(1),
...
static NODE_PROPERTIES: &[PropertyDescriptor] = &[
    PropertyDescriptor {
...
static NODE_METHODS: &[MethodDescriptor] = &[
    MethodDescriptor {
        code: MethodCode::new(1),
...
static LIST_METHODS: &[MethodDescriptor] = &[
    MethodDescriptor {
        code: MethodCode::new(1),
