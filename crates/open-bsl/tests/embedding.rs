...
/// срабатывает, выбирается `#Иначе` (измерено, см. `docs/reference/language/preprocessor.md`).
...
/// программы» в `docs/reference/language/preprocessor.md`: один исходник, две сборки, разные
